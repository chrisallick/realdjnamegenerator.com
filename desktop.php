...
<html>
    <head>
        ...
        <meta charset="utf-8">
        <meta name="description" content="Real DJ Name Generator">
        <meta name="keywords" content="dj, generator, real dj name, dj name, name">
    ...
    <body>
        <div id="wrapper" class="clear">
            ...
            <div class="right">
                <div id="create">
                    <div class="copy">
                        <p class="info first">Whether you're playing sold out stadiums or making bedroom bangerz, you need a DJ name that's as unique as you are.</br></br>Enter your first and last name below...</p>
                        <p class="info last"></p>
                    </div>
                    <div id="tape">
                        <form>
            ...
            <div id="about">
                <div class="copy">
                    <p>Designed by <a href="http://www.michaelkleinman.net" target="_blank">Michael Kleinman</a><br/><br/>Developed by <a href="http://chrisallick.com" target="_blank">Chris Allick</a></p>
                </div>
            </div>
